...
public class EditProjectActionBean extends BasicActionBean {
      ...
      public void setFreeResearchers(List<Researcher> freeResearchers) {this.freeResearchers = freeResearchers;}


      public List<Long> getSelectedApprove() {return selectedApprove;}
      public void setSelectedApprove(List<Long> selectedApprove) {this.selectedApprove = selectedApprove;}

      public List<Long> getSelected() {return selected;}
      public void setSelected(List<Long> selected) {this.selected = selected;}
