...
//            List<File> files = FileUtils.getFiles(storagePath + biobank.getBiobankMonitoringFolder());
//
...
//                if (FileUtils.copyFile(file, storagePath + biobank.getBiobankMonitoringArchiveFolder()) == Constant.SUCCESS) {
