...
public class CreatePatientActionBean extends PermissionActionBean {
    ...
    public Resolution createPatient() {
        ...
        if (!biobankFacade.createPatient(patient, biobankId, getContext().getValidationErrors())) {
            return new ForwardResolution(cz.bbmri.action.biobank.BiobankActionBean.class, "patients")
                    .addParameter("biobankId", biobankId);
        }
        successMsg(null);
        return new RedirectResolution(cz.bbmri.action.biobank.BiobankActionBean.class, "patients")
                .addParameter("biobankId", biobankId);
    }
