package cz.bbmri.entity.webEntities;
...
public class Breadcrumb {
     ...
     */
    public Breadcrumb(String actionBean, String event, boolean notMsgKey, String msgKey, boolean active,
                      String param, Number paramValue) {
        this.actionBean = actionBean;
        this.event = event;
        this.notMsgKey = notMsgKey;
        this.msgKey = msgKey;
     ...
     * @param objectName
     */
    public Breadcrumb(String actionBean, String event, boolean notMsgKey, String msgKey, boolean active, String param, Number paramValue, String objectName) {
        this.actionBean = actionBean;
        this.event = event;
        this.notMsgKey = notMsgKey;
        this.msgKey = msgKey;
