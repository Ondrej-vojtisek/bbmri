...
<s:layout-definition>
    ...
    <security:allowed bean="biobankActionBean" event="detail">
        <li <c:if test="${ternarymenu == 'detail'}"> class="active" </c:if> >
            <s:link beanclass="cz.bbmri.action.BiobankActionBean" event="detail">
                ...
                <f:message key="cz.bbmri.action.BiobankActionBean.basicData"/>
            </s:link>
        </li>
    </security:allowed>
    ...
    <%--<li <c:if test="${ternarymenu == 'infrastructure'}"> class="active" </c:if>>--%>
        <%--<s:link beanclass="cz.bbmri.action.infrastructure.InfrastructureActionBean" event="all">--%>
            <%--<s:param name="biobankId" value="${actionBean.biobankId}"/>--%>
            <%--<f:message key="cz.bbmri.entitynfrastructure.Infrastructure.infrastructure"/>--%>
        <%--</s:link>--%>
    <%--</li>--%>
    ...
    <%--<s:param name="biobankId" value="${actionBean.biobankId}"/>--%>
    <%--<f:message key="cz.bbmri.entitynfrastructure.monitoring.Monitoring.monitoring"/>--%>
    <%--</s:link>--%>
    <%--</li>--%>
