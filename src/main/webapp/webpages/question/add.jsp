    ...
    <stripes:layout-component name="body">
        ...
        <stripes:form beanclass="cz.bbmri.action.QuestionActionBean">
            ...
            <stripes:label for="cz.bbmri.entity.Reservation.selectBiobank">
                <format:message key="cz.bbmri.entity.Reservation.selectBiobank"/>
            </stripes:label>
            <table class="table">
            ...
            <stripes:label for="cz.bbmri.entity.Question.specification">
                <format:message key="cz.bbmri.entity.Question.specification"/>
            </stripes:label>
            ...
            <div class="form-actions">
                ...
                <stripes:link name="questions" beanclass="cz.bbmri.action.ProjectActionBean"
