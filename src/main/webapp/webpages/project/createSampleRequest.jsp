...
<s:layout-render name="/layouts/layout_content.jsp" title="${title}"
    ...
    <s:layout-component name="body">
        ...
        <fieldset>
            <legend><f:message key="cz.bbmri.action.project.ProjectActionBean.createSampleRequest.legend"/></legend>
                ...
                <div class="form-actions">
                    <security:allowed bean="projectBean" event="detail">
                        <s:link beanclass="${projectBean.name}" event="detail" class="btn btn-inverse btnMargin">
                            ...
                            <f:message key="cz.bbmri.action.project.ProjectActionBean.cancelSampleRequest"/>
                        </s:link>
                    </security:allowed>
