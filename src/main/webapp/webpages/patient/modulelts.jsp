    ...
    <stripes:layout-component name="body">
        ...
        <div class="form-actions">
            ...
            <stripes:link beanclass="cz.bbmri.action.sample.CreateSampleActionBean" event="initial"
                ...
                <stripes:param name="moduleId" value="${actionBean.patient.moduleLTS.id}"/>
        ...
        <%--<stripes:layout-render name="/webpages/component/samples.jsp" samples="${actionBean.patient.moduleLTS}"/>--%>
